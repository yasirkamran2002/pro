...
| $$\  $$$              | $$          | $$\  $$  /$$__  $$| $$ | $$ | $$| $$      /$$__  $$| $$  | $$
| $$ \  $$ /$$          | $$          | $$ \  $$|  $$$$$$$| $$ | $$ | $$| $$     |  $$$$$$$| $$  | $$
|__/  \__/| $/          |__/          |__/  \__/ \_______/|__/ |__/ |__/|__/      \_______/|__/  |__/
          |_/                                                                                        
                                                                                                     
                                                                                                     

\033[1;91m=======================================
\033[1;96mAuthor  \033[1;93m: \033[1;92mN, Y Kamran
\033[1;96mGitHub  \033[1;93m: \033[1;92mhttps://github.com/yasirkamran2002/pro
\033[1;91m======================================="""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
\033[1;91m======================================="""
print " \x1b[1;93m============================================================="
CorrectUsername = "yasirkamran2002"
CorrectPassword = "1234567891"
loop = 'true'
while (loop == 'true'):
